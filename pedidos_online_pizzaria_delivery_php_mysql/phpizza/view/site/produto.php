...
<html>
                        ...
                        <div class="item">
                            <?php foreach ($data['item'][0] as $item): ?>
                                <div class="col-md-4 col-xs-12">
                                    <img src="<?= Http::base() ?>/midias/thumb.php?zcx=3&w=218&h=178&src=item/<?= $item->item_foto ?>" alt="..."  class="img-responsive">
                                </div>
    ...
    <script type="text/javascript" src="<?= Http::base() ?>/assets/js/main.js"></script>
</html>