...
<html>
    ...
    <body>
                ...
                <form action="<?= Http::base() ?>/meu-endereco-salvar/" method="post" role="form" autocomplete="off" enctype="multipart/form-data"> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="endereco_nome" id="endereco_nome"
                               class="form-control" placeholder="Informe uma descrição para o endereço ex: Casa, Escritório, Praia" 
                        ...
                        <div class="col-md-3 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Ex: Centro"  name="endereco_bairro"  id="endereco_bairro" class="form-control"  required
                                       value="<?= $data['endereco']->endereco_bairro; ?>">
                            </div>                                        
                        </div>                                        
                        <div class="form-group">
                            <div class="col-md-6 col-xs-12">
                                <label for="endereco_endereco">Endereço</label> 
                                <input type="text" placeholder="Ex: Avenida Paulista"  name="endereco_endereco"  id="endereco_endereco" class="form-control"  
                    ...
                    <div class="form-group hidden-xs text-center">
                        <button class="btn btn-success btn-lg btn-endereco-gravar" type="submit">
                            <i class="fa fa-refresh"></i> Atualizar
                        </button>
                    </div>
                    <div class="form-group visible-xs">
                        <button class="btn btn-success btn-block btn-lg btn-endereco-gravar" data-dismiss="modal" type="submit">
        ...
        <script src="<?= Http::base() ?>/view/site/app-js/endereco.js"></script>
