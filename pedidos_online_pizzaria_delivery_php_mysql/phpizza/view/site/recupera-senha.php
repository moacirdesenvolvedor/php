            ...
            <div class="row">
                <div id="cl-wrapper">
                    <div class="content col-md-offset-4">
                        <form action="<?= Http::base() ?>/LoginCliente/recuperar<?= (isset($data['carrinho'])) ? '?carrinho' : '' ?>" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="text-danger text-center">Um link de segurança para recuperar sua senha<br> será enviado para seu email</p>
                                    </div>
                                </div>
