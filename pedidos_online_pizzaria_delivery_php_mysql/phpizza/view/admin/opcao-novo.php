    ...
    <body class="animated">
        <div id="cl-wrapper">
            ...
            <div class="container-fluid" id="pcont">
                ...
                <div class="cl-mcont">
                    <h3 class="text-center">Cadastrar Opção</h3>
                    <div class="block-flat">
                        <div class="header">							
                            <h3><?= $data['item']->categoria_nome ?> > <?= $data['item']->item_nome ?> > <span class="text-primary">Nova Opção do Item</span>
                                <span class="pull-right"><a href="<?= Http::base() ?>/opcao/item/<?= $data['item']->item_id ?>/" class="btn btn-primary"><i class="fa fa-chevron-circle-left"></i> Listar Itens</a></span>
                            </h3>
                        </div>
                        <div class="content">
                            <form action="<?= Http::base() ?>/opcao/gravar/" method="post" role="form" autocomplete="off"  enctype="multipart/form-data"> 
                                <input type="hidden" name="opcao_item" value="<?= $data['item']->item_id ?>" />
                                <div class="row">
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form-group">
                                            <label for="opcao_nome">Nome da opção</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="opcao_desc" id="opcao_desc" class="form-control"></textarea>
                                </div>                                        
                                <p class="text-center">
