                    ...
                    <div class="block-flat">
                        <div class="header">							
                            <h3><?= $data['cliente']->cliente_nome ?> - <span class="text-info">Novo Endereço</span> 
                                <span class="pull-right"><a href="<?= Http::base() ?>/endereco/lista/<?= $data['cliente']->cliente_id ?>/" class="btn btn-primary"><i class="fa fa-chevron-circle-left"></i> Listar Endereços</a></span>
                            </h3>
                        </div>
                        <div class="content">
                            <form action="<?= Http::base() ?>/endereco/gravar/" method="post" role="form" autocomplete="off" enctype="multipart/form-data"> 
