                        ...
                        <div class="header">							
                            <h3>Endereços de <?= $data['cliente']->cliente_nome ?>
                                <span class="pull-right">
                                    ...
                                    <a href="<?= Http::base() ?>/endereco/novo/<?= $data['cliente']->cliente_id ?>/" class="btn btn-primary btn-novo"><i class="fa fa-plus-circle"></i> Cadastrar Novo</a>
                                </span>
                            </h3>
                        </div>
                        <div class="content">
                                        ...
                                        <?php if (isset($data['endereco'][0])): ?>
                                            <?php foreach ($data['endereco'] as $obj): ?>
                                                <tr class="gradeA" id="tr-<?= $obj->endereco_id ?>">
                                                    ...
                                                    <td class="center">
                                                        <a href="<?= Http::base() ?>/endereco/editar/<?= $obj->endereco_id ?>/" title="Editar" data-toggle="tooltip"
                                                           class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>
                                                        </a>
                                                        <button data-id="<?= $obj->endereco_id ?>"   title="Remover" data-toggle="tooltip" 
                ...
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form name="form-remove" id="form-remove" action="<?= Http::base() ?>/endereco/remove/" method="post">
