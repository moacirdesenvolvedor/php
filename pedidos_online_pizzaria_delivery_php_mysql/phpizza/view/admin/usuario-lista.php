    ...
    <body class="animated">
        <div id="cl-wrapper">
            ...
            <div class="container-fluid" id="pcont">
                ...
                <div class="cl-mcont">
                    ...
                    <div class="block-flat">
                        <div class="header">							
                            <h3>Usuários 
                                <span class="pull-right"><button type="button" class="btn btn-primary btn-novo"><i class="fa fa-plus-circle"></i> Cadastrar Novo</button></span>
                            </h3>
                        </div>
                        <div class="content">
                                        ...
                                        <?php if (isset($data['usuario'][0])): ?>
                                            <?php foreach ($data['usuario'] as $obj): ?>
                                                <tr class="gradeA" id="tr-<?= $obj->usuario_id ?>">
                                                    ...
                                                    <td id="td-fone" class="center"><?= $obj->usuario_fone ?></td>
                                                    <td class="center">
                                                        <button 
                                                            data-id="<?= $obj->usuario_id ?>" 
                                                            data-nome="<?= $obj->usuario_nome ?>" 
                                                            data-email="<?= $obj->usuario_email ?>" 
                                                            data-login="<?= $obj->usuario_login ?>" 
                                                            data-fone="<?= $obj->usuario_fone ?>"
                                                            data-image="<?= $obj->usuario_avatar ?>" 
                                                            class="btn btn-sm btn-primary btn-editar" data-toggle="modal"><i class="fa fa-edit"></i>
                                                        </button>
                                                        <button data-id="<?= $obj->usuario_id ?>"  
            ...
            <div class="modal fade colored-header" id="modal-editar" tabindex="-1" role="dialog">
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        <form name="form-editar" id="form-editar" action="<?= Http::base() ?>/usuario/gravar/" method="post">
            ...
            <div class="modal fade colored-header" id="modal-novo" tabindex="-1" role="dialog">
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        <form name="form-novo" id="form-novo" action="<?= Http::base() ?>/usuario/gravar/" method="post">
                            <div class="modal-header">
                                <h3>Novo Usuário</h3>
                                <button type="button" class="close md-close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            </div>
            ...
            <div class="modal fade colored-header warning md-effect-10" id="modal-remove" tabindex="-1" role="dialog">
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form name="form-remove" id="form-remove" action="<?= Http::base() ?>/usuario/remove/" method="post">
