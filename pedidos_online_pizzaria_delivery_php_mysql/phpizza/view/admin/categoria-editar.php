                    ...
                    <div class="block-flat">
                        ...
                        <div class="content">
                            <form action="<?= Http::base() ?>/categoria/gravar/" method="post" role="form" autocomplete="off"> 
                                <input type="hidden"  name="categoria_id"  id="categoria_id" value="<?= $data['categoria']->categoria_id ?>">                                        
                                <div class="col-md-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="categoria_nome">Nome completo</label> 
                                        <input type="text"  name="categoria_nome"  id="categoria_nome" 
                                               class="form-control" placeholder="Informe o nome do contato responsável" 
                                         value="<?= $data['categoria']->categoria_nome ?>" required />
                                    </div>  
                                </div>  
                                ...
                                <div class="col-md-3 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="categoria_pos" id="categoria_pos" class="form-control" placeholder="Informe a posição da categoria" 
                                                   value="<?= $data['categoria']->categoria_pos ?>" required>
