            ...
            <div class="container-fluid" id="pcont">
                ...
                <div class="cl-mcont">
                    ...
                    <div class="block-flat">
                        ...
                        <div class="content">
                            <form action="<?= Http::base() ?>/cliente/gravar/" method="post" role="form" autocomplete="off" enctype="multipart/form-data"> 
                                <input type="hidden"  name="cliente_id"  id="cliente_id" value="<?= $data->cliente_id ?>">                                        
                                <div class="form-group">
                                    <label for="cliente_nome">Nome completo</label> 
                                    <input type="text"  name="cliente_nome"  id="cliente_nome" class="form-control" placeholder="Informe o nome do contato responsável" value="<?= $data->cliente_nome ?>" required>
                                </div>                                   
                                <div class="form-group">
                                    <label for="cliente_cpf">CPF</label> 
                                    <input type="text"  data-mask="cpf" name="cliente_cpf" id="cliente_cpf" class="form-control" placeholder="Informe o número do documento"  value="<?= $data->cliente_cpf ?>">
                                </div>           
                                <div class="header">							
                                    <h4>Contato</h4>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" data-mask="cell" placeholder="(99) 99999-9999"  name="cliente_fone2"  id="cliente_fone2" class="form-control"  value="<?= $data->cliente_fone2 ?>">
                                </div>
                                <div class="form-group">
                                    <label for="cliente_fone">Fone Fixo</label> 
                                    <input type="text" data-mask="phone" placeholder="(99) 9999-9999"  name="cliente_fone"  id="cliente_fone" class="form-control"  value="<?= $data->cliente_fone ?>">
                                </div>                                      
                                <div class="form-group">
                                    <label>Fone Personalizado</label> 
                                    <input type="text" placeholder="(99) 999-999-999 (WhatsApp)"  name="cliente_fone3"  id="cliente_fone3" class="form-control"  value="<?= $data->cliente_fone3 ?>">
                                </div>        
                                <div class="form-group">
                                    <label for="cliente_email">Email</label> 
                                    <input type="email" name="cliente_email" id="cliente_email" class="form-control" placeholder="informe um email válido"  required  value="<?= $data->cliente_email ?>">
                                </div>                                             
                                <div class="form-group">
