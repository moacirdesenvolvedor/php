            ...
            <div class="container-fluid" id="pcont">
                ...
                <div class="cl-mcont">
                    ...
                    <div class="block-flat">
                        ...
                        <div class="content">
                            <form action="<?= Http::base() ?>/configuracao-email-atualizar/gravar/" method="post" role="form" autocomplete="off" enctype="multipart/form-data"> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="smtp_host" id="smtp_host" class="form-control" placeholder="Informe o endereço SMTP ex: mail.site.com.br" 
                                                       value="<?= $data['smtp']->smtp_host ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="smtp_port">Porta SMTP <span class="text-danger">*</span></label> 
                                                <input type="text" name="smtp_port" id="smtp_port" class="form-control" placeholder="Informe a porta SMTP ex: 587" 
                                                       value="<?= $data['smtp']->smtp_port ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="smtp_nome" id="smtp_nome" class="form-control" placeholder="Informe o nome de exibição ex: Abidu Esfihas" 
                                                       value="<?= $data['smtp']->smtp_nome ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="smtp_email" id="smtp_email" class="form-control" placeholder="Informe a conta SMTP contato@site.com.br" 
                                                       value="<?= $data['smtp']->smtp_email ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="smtp_pass">Senha  (smtp)<span class="text-danger">*</span> </label> 
                                                <input type="password" name="smtp_pass" id="smtp_pass" class="form-control" placeholder="Informe a senha SMTP" 
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="smtp_bcc" id="smtp_bcc" class="form-control" placeholder="Informe um email alternativo ex: outro@gmail.com" 
                                                       value="<?= $data['smtp']->smtp_bcc ?>">
                                            </div>
                                        </div>
                                    </div>
