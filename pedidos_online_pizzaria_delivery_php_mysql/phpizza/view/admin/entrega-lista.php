            ...
            <div class="container-fluid" id="pcont">
                ...
                <div class="cl-mcont">
                    ...
                    <div class="block-flat">
                        ...
                        <div class="content">
                            <form action="<?= Http::base() ?>/entrega/gravar/" method="post" class>
                                        ...
                                        <?php if (isset($data[0])): ?>
                                            <?php foreach ($data as $obj): ?>
                                                <tr class="gradeA" id="tr-<?= $obj->entrega_id ?>">
                                                    ...
                                                    <td class="center">
                                                        <a href="<?= Http::base() ?>/entrega/remove/<?= $obj->entrega_id ?>/" title="Remover"  data-toggle="tooltip"
                ...
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form name="form-remove" id="form-remove" action="<?= Http::base() ?>/entrega/remove/" method="post">
