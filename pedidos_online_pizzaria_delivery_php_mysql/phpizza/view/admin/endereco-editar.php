                    ...
                    <div class="block-flat">
                        <div class="header">							
                            <h3><?= $data['endereco']->cliente_nome ?> - Novo Endereço 
                                <span class="pull-right"><a href="<?= Http::base() ?>/endereco/lista/<?= $data['endereco']->cliente_id ?>/" class="btn btn-primary"><i class="fa fa-chevron-circle-left"></i> Listar Endereços</a></span>
                            </h3>
                        </div>
                        <div class="content">
