                                    ...
                                    <div class="col-md-4 col-xs-12">
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control sys-datas" name="chamado_inicio" id="chamado_inicio"
                                                       data-format="dd-mm-yyyy hh:ii" type="text" required />
                                            </div>                                        
                                        </div>                                        
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group">
                                                <label>Data Final</label> 
                                                <input class="form-control sys-datas" name="chamado_entrega" id="chamado_entrega"
                                                       data-format="dd-mm-yyyy hh:ii" type="text" />
                                            </div>                                        
                                        </div> 
                                    </div>                                       
