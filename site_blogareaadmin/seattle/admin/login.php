    ...
    <body>
        ...
        <div id="sign-wrapper">
            ...
            <?php if (isset($_GET['erro'])): ?>
                                <p class="text-center text-danger">Login ou senha estão incorretos!</p>
            <?php endif; ?>
        ...
        <script>
<?php if (isset($_GET['erro'])): ?>
               // noty({                    text: 'Login ou senha estão incorretos!',                    layout: 'top',                    closeWith: ['click', 'hover'],                    type: 'error'                                    });
<?php endif; ?>
