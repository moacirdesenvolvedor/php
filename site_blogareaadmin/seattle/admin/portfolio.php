                    ...
                    <ul id="gallery">
                        <?php if (isset($portfolio->db->data[0])): ?>
                            <?php foreach ($portfolio->db->data as $listar): ?>
                                <li class="mix <?= Filter::slug2($listar->area1_nome) ?> col-md-3" >
                                    <div class="gallery-item rounded shadow">
                                        <span class="gallery-love">
                                            <i class="fa fa-heart-o"></i>
                                        </span>
                                        <a href="javascript:void(0);" style="cursor:default" class="gallery-img"><img src="thumb.php?w=400&h=250&zc=0&src=../images/portfolio/<?= $listar->portfolio_imagem ?>" class="img-responsive full-width" alt="..." /></a>
                                        <br />
                                        ...
                                        <div class="gallery-details">
                                            ...
                                            <div class="text-center">
                                                <a class="btn btn-circle btn-info atualizar"  href="portfolio/editar/<?= $listar->portfolio_id ?>/">
