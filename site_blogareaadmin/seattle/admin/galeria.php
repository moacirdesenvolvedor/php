...
$cat_galeria = new Catgaleria();
$cat_galeria->db = new DB;
$cat_galeria->getCatGalerias();
?>
<!DOCTYPE html>
        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                <div class="header-content">
                    <h2><i class="fa fa-photo"></i> <span>Álbuns Cadastrados</span></h2>
                ...
                <div class="body-content animated fadeIn">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-left">
                                ...
                                <?php if (isset($cat_galeria->db->data[0])): ?>
                                    <?php foreach ($cat_galeria->db->data as $cat): ?>
                                        <button class="filter btn btn-primary btn-sm" data-filter=".<?= Filter::slug2($cat->cat_galeria_nome) ?>" ><?= stripslashes($cat->cat_galeria_nome) ?></button>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </div>
                    ...
                    <ul id="gallery">
                        <?php if (isset($galeria->db->data[0])): ?>
                            <?php foreach ($galeria->db->data as $listar): ?>
                                <li class="mix <?= Filter::slug2($listar->cat_galeria_nome) ?> col-md-3" >
                                    <div class="gallery-item rounded shadow">
                                        <span class="gallery-love">
                                            <i class="fa fa-heart-o"></i>
                                        </span>
                                        <a href="javascript:void(0);" style="cursor:default" class="gallery-img"><img src="thumb.php?w=400&h=250&zc=0&src=../images/galeria/<?= $listar->galeria_imagem ?>" class="img-responsive full-width" alt="..." /></a>
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading text-capitalize">
                                                        <?= stripslashes($listar->galeria_nome) ?>                                                        
                                                    </h4>
                                                    <span class=""> 
                                                        Categoria: <?= stripslashes($listar->cat_galeria_nome) ?>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="gallery-details">
                                            <div class="text-center">
                                                <a class="btn btn-circle btn-info atualizar"  href="galeria/editar/<?= $listar->galeria_id ?>/">
                                                    <i class="fa fa-edit icon-white"></i>
                                                </a>
                                                <a class="btn btn-circle btn-danger delete" data-url="galeria_fn.php?acao=remover&AMP;id=<?= $listar->galeria_id ?>">
