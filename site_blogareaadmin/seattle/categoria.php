                                        ...
                                        <article class="post clearfix">
                                            <div class="postPic">
                                                <div class="imgBorder mb15">
                                                    <a href="post/<?= Filter::slug2($pos->pagina_nome) ?>/<?= $pos->pagina_id ?>/"><img src="thumb.php?w=750&h=400&zc=0&src=images/blog/<?= $pos->pagina_imagem ?>" alt="" class="img-responsive" /></a>
                                                </div>
                                            </div>
                                            <div class="row">
