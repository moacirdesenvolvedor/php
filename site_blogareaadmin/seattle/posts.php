                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb visible-md visible-lg">
                                    ...
                                    <li><a href="javascript:void(0);"  style="cursor:default">Blog</a></li>
                                        ...
                                        <article class="post clearfix">
                                            ...
                                            <div class="row">
                                                <section class="col-sm-11 col-xs-10">
                                                    ...
                                                    <ul class="entry-meta">
                                                        <li class="entry-date"><a href="javascript:void(0);" style="cursor:default"><i class="icon-pin"></i><?= $data[0] ?> <?= $data[1] ?>. <?= $data[2] ?></a></li>
                                                        <li class="entry-category"><a href="javascript:void(0);"  style="cursor:default"><i class="icon-th-list"></i>&nbsp;<?= stripslashes($pos->area_nome) ?></a></li>
                                                        <li class="entry-author"><a href="javascript:void(0);"  style="cursor:default"><i class="icon-male"></i>&nbsp;<?= stripslashes($pos->pagina_autor) ?></a></li>
                                                        <li class="entry-comments"><a href="javascript:void(0);"  style="cursor:default"><i class="icon-comment-1"></i><?= $pagina->CountComentario($pos->pagina_id) ?> Comentários</a></li>
                                                    </ul>
                                                </section>
                                            </div>
                                        </article>
