$(function () {
    ...
    var popcontent = '<p>Para uma melhor exibi??o, cadastre apenas o t?tulo do item. Exemplo:<br /> <b> Smartphone Motorola Atrix 3G</b>';
    ...
    var popcontent2 = '<p>Separe as palavras por v?rgula. Exemplo:<br /> <b> 3G, Wi-Fi, LCD, LED, PRETO...</b><p>';
    ...
    var popcontent3 = '<p>Esta op??o determina se o Item aparecer? ou n?o no site.<p>';
    $('#item_show').popover({
        placement: 'right',
        title: 'Item Ativo',
        html: true,
    ...
    $('#btn-remove-cancel').live('click', function (e) {
        ...
        notify('<h1>Sele?ao cancelada</h1>');
    })
    //seleciona todas 
