                        ...
                        <div class="content">
                            <form action="<?php echo $baseUri; ?>/item/gravar/" method="post" role="form" autocomplete="off" enctype="multipart/form-data"> 
                                <div class="row">
                                            ...
                                            <div class="col-md-2 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="item_codigo"
                                                           id="item_codigo" class="form-control text-uppercase"
                                                           placeholder="ex: P001">
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-xs-12">
                                    ...
                                    <div class="col-md-2 col-xs-12">
                                        <div class="form-group">
                                            <img src="<?php echo $baseUri; ?>/midias/thumb.php?zcc=3&w=440&h=250&src=img/sem_foto.jpg" alt="Foto" class="img-responsive"/>
                                        </div>
