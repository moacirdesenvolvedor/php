...
<head>
    ...
    <body class="animated">
        <div id="cl-wrapper">
            ...
            <div class="container-fluid" id="pcont">
                ...
                <div class="cl-mcont">
                    ...
                    <div class="block-flat">
                        ...
                        <div class="content">
                            <form action="<?php echo $baseUri; ?>/cliente/gravar/" method="post" role="form"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cliente_nome" id="cliente_nome" class="form-control"
                                           placeholder="Informe o nome do contato responsável" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-mask="cell" required placeholder="(99) 99999-9999"
            ...
            <script type="text/javascript">$('#menu-cliente').addClass('active');</script>
