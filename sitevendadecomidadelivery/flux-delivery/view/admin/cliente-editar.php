                        ...
                        <div class="content">
                            <form action="<?php echo $baseUri; ?>/cliente/gravar/" method="post" role="form" autocomplete="off" enctype="multipart/form-data"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cliente_nome" id="cliente_nome" class="form-control" placeholder="Informe o nome do contato responsável" value="<?= $data['cliente']->cliente_nome ?>"
                                           required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" data-mask="date" name="cliente_nasc" id="cliente_nasc"
                                           ...
                                           class="form-control" placeholder="Informe a data de nascimento">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required data-mask="cell" placeholder="(99) 99999-9999"
                                           name="cliente_fone2" id="cliente_fone2" class="form-control"
                                           value="<?= $data['cliente']->cliente_fone2 ?>">
                                </div>
                                <!--
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="cliente_senha" id="cliente_senha" class="form-control"
                                           placeholder="informe uma senha" value="">
                                </div>
                                <p class="text-center">
