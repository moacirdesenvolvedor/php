                            ...
                            <form action="<?php echo $baseUri; ?>/categoria/gravar/" method="post" role="form" autocomplete="off" enctype="multipart/form-data"> 
                                ...
                                <div class="col-md-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="categoria_nome"  id="categoria_nome" 
                                               class="form-control" placeholder="Informe o nome da categoria" 
                                ...
                                <div class="col-md-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file"  name="categoria_img"  id="categoria_img" 
                                               class="form-control" placeholder="Selecione uma imagem de capa"/>
                                    </div>  
                                </div>                                                        
                                <div class="col-md-3 col-xs-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="categoria_pos" id="categoria_pos" class="form-control" 
                                            placeholder="Informe a posição da categoria"  value="<?= $data['categoria']->categoria_pos ?>"
                                             required>
                                        </div>                                                                               
                                    </div>                                                                               
                                </div>  
...
?>
            ...
            <script type="text/javascript">
                ...
                $('#categoria_meia').val('<?= $data['categoria']
                    ->categoria_meia ?>');
            </script>
