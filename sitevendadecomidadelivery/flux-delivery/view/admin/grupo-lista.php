                ...
                <div class="header">
                    <h3>
                        ...
                        <span class="pull-right">
                            <a href="<?php echo $baseUri; ?>/grupo/novo/" 
                                ...
                                <?php foreach ($data['grupos'] as $obj): ?>
                                    <tr class="gradeA" id="tr-<?= $obj->grupo_id ?>">
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo $baseUri; ?>/grupo/opcao/<?= $obj->grupo_id ?>/" 
                                                title="Opções do Grupo" 
                                                data-toggle="tooltip"
                                               class="btn btn-sm btn-info"><i class="fa fa-th-list"></i>
                                            </a>                                            
                                            <a href="<?php echo $baseUri; ?>/grupo/editar/<?= $obj->grupo_id ?>/" title="editar" 
                                               data-toggle="tooltip"
                                               class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>
                                            </a>
                                            <button data-id="<?= $obj->grupo_id ?>" title="excluir" data-toggle="tooltip"
