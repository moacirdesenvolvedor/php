                                ...
                                <input type="hidden"  name="grupo_id"  id="grupo_id" value="<?= $data['grupo']->grupo_id ?>">                                        
                                    <div class="col-md-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="grupo_nome"  id="grupo_nome" 
                                                class="form-control" placeholder="Informe o nome de exibição" 
                                            value="<?= $data['grupo']->grupo_nome ?>" required />
                                        </div>  
                                    </div>  
                                    <div class="col-md-3 col-xs-12">
                                        <div class="form-group">
                                            <label for="grupo_nome">Nome Interno <small>(controle adm)</small></label> 
                                            <input type="text"  name="grupo_desc"  id="grupo_desc" 
                                                class="form-control" placeholder="Informe o nome interno" 
                                            value="<?= $data['grupo']->grupo_desc ?>" required />
                                        </div>  
                                    </div>          
                                    ...
                                    <div class="col-md-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select  name="grupo_tipo"  id="grupo_tipo" 
                                                    class="form-control">
                                    ...
                                    <div class="col-md-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="grupo_limite"  id="grupo_limite"  min="0"
                                                class="form-control" placeholder="Limite de opções" 
                                            value="<?= $data['grupo']->grupo_limite ?>"  />
                                        </div>  
                                    </div>                                 
