                                    ...
                                    <tr class="gradeA" id="tr-<?= $obj->categoria_id ?>">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php if($obj->categoria_ativa == 1): ?>
                                                <a data-id="<?= $obj->categoria_id ?>" data-status="<?= $obj->categoria_ativa ?>" title="Desativar categoria" data-toggle="tooltip"
                                                   class="btn btn-sm btn-danger btn-status">
                                                    <i class="fa fa-ban"></i>
                                                </a>
                                            <?php else: ?>
                                                <a data-id="<?= $obj->categoria_id ?>" data-status="<?= $obj->categoria_ativa ?>" title="Ativar categoria" data-toggle="tooltip"
                                                   class="btn btn-sm btn-success btn-status">
                                                    <i class="fa fa-check"></i>
                                                </a>
                                            <?php endif; ?>

                                            <button data-id="<?= $obj->categoria_id ?>/" title="remover banner" data-toggle="tooltip" type="button"
                                               class="btn btn-sm btn-danger btn-banner"><i class="fa fa-picture-o"></i>
                                            </button>

                                            <a href="<?php echo $baseUri; ?>/categoria/duplicar/<?= $obj->categoria_id ?>/" title="duplicar categoria" data-toggle="tooltip"
                                               class="btn btn-sm btn-primary"><i class="fa fa-copy"></i>
                                            </a>

                                            <a href="<?php echo $baseUri; ?>/categoria/editar/<?= $obj->categoria_id ?>/" title="editar categoria" data-toggle="tooltip"
                                               class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>
                                            </a>

                                            <a href="<?php echo $baseUri; ?>/categoria/item/<?= $obj->categoria_id ?>/" title="Produtos da Categoria" data-toggle="tooltip"
                                               class="btn btn-sm btn-info"><i class="fa fa-th-list"></i>
                                            </a>
                                                
                                            <a href="<?php echo $baseUri; ?>/categoria/grupo/<?= $obj->categoria_id ?>/" title="Grupos da Categoria" data-toggle="tooltip"
                                               class="btn btn-sm btn-warning"><i class="fa fa-th"></i>
                                            </a>

                                            <button data-id="<?= $obj->categoria_id ?>" title="Remover Categoria" data-toggle="tooltip"
