        ...
        <div class="lista-item">
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default" class="text-uppercase" 
                               ...
                               >
                    <div class="panel-heading" role="tab" id="heading-<?php echo $categoria_id; ?>"
data-toggle="collapse" data-parent="#accordion"
                               href="#collapse-<?php echo $categoria_id; ?>" 
                               aria-expanded="true" aria-controls="collapse-<?php echo $categoria_id; ?>" style="cursor: pointer;"
                    ...
                    <div id="collapse-<?php echo $categoria_id; ?>" class="panel-collapse collapse <?= ($iterator == 0) ? 'ins' : ''; ?>" role="tabpanel"
                         aria-labelledby="heading-<?php echo $categoria_id; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="lista-item-box"
                                         ...
                                         data-target="#item-<?= $item->item_id; ?>"
                                         style="margin-bottom:20px">
                                        <?php else : ?>
                                        <div class="lista-item-box add-item"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h5 class="modal-title text-uppercase text-center">Detalhes e
                                                            Opções
                                                            <small
                                                                    class="text-muted"> <Br><?= $categoria_nome ?>
                                                            </small>
                                                        </h5>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <?php if (isset($opcoes[0])) : ?>
                                                            ...
                                                            <div class="form-check opt-<?= $item->item_id ?> grupo-<?= $opc->grupo_id ?>"
                                                                data-preco="<?= Currency::moedaUS($item->item_preco) ?>">
    ...
    <script>var currentUri = 'index';</script>
