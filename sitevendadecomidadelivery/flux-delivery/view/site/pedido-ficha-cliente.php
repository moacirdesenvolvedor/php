        ...
        <div class="panel-heading panel-heading-red">
            <div class="row">
                <h3 class="text-center">
                    Olá <?= $data['pedido']->cliente_nome ?>, confira os dados de seu pedido!
                    <br><br>
                                    ...
                                    <span class="item-span">
                                        <span>
                                            ...
                                            <span class="pull-right mar-right-3" data-toggle="tooltip"
                                                  title="<?= $cart->qtde ?> x <?= Currency::moeda($cart->lista_opcao_preco) ?>">R$ <?= Currency::moeda($cart->lista_opcao_preco * $cart->lista_qtde) ?> </span>
                                        </span>
                                    </span>
                        </div>
                    <?php endforeach; ?>
                    <?php if ($data['pedido']->pedido_obs != ""): ?>
                        <p>Observações: <?= strip_tags($data['pedido']->pedido_obs) ?> </p>
                    <?php endif; ?>
                    <?php if ($data['pedido']->pedido_obs_pagto != ""): ?>
                        <p>Pagto: <?= strip_tags($data['pedido']->pedido_obs_pagto) ?> </p>
                    <?php endif; ?>
                </div>
                <hr>
